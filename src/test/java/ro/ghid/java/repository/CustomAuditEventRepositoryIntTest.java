...
import ro.ghid.java.config.audit.AuditEventConverter;
import ro.ghid.java.domain.PersistentAuditEvent;
...
import static ro.ghid.java.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
